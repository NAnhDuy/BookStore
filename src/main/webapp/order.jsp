                    ...
                    <div class="col-md-5">
                        <div class="card border-0">
                            <div class="card-header pb-0">
                                ...
                                <p class="card-text text-muted mt-4 space">CHI TIẾT VẬN CHUYỂN</p>
                                <hr class="my-0">
                            </div>
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-auto form-group">
                                        ...
                                        <textarea wrap="soft" style="width: 350%; height: 100%; resize: none" class="form-control form-control-sm" name="NAME" placeholder="Thành phố/Tỉnh.."></textarea>
                                    </div>
                                </div>
                                <br>
                                <div class="row mt-4">
                                ...
                                <div class="form-group">
                                    <label for="NAME" class="text-muted mb-1">Họ Tên Người Nhận</label>
                                    <input type="text" class="form-control form-control-sm" name="NAME" id="NAME" aria-describedby="helpId" placeholder="họ và tên..">
                                </div>
                                <div class="form-group">
                                    <p for="NAME" class="text-muted mb-1">Phương Thức Thanh Toán</p>
                                ...
                                <div class="row mb-md-5">
                                    <div class="col"> <button type="button" name="" id="" class="btn btn-lg btn-block ">
                                        Thanh Toán Sản Phẩm</button> </div>
                                </div>
                            </div>
                        </div>
                    </div>
