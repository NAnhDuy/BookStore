...
<div class="pd-wrap">
    <div class="container">
        ...
        <div class="alert alert-danger" role="alert">
            ...
            <a href="ProductDeleteController.html?product_id=${product.id}"
               class="ml-5 mr-1 btn btn-outline-info btn-md btn-rounded btn-navbar waves-effect waves-light"
                                                          style="font-size: 14px">Có</a>  -
            <a href="InformationProductController.html?id=${product.id}&number=0" class="ml-1 btn btn-outline-info btn-md btn-rounded btn-navbar waves-effect waves-light"
               style="font-size: 14px">Không</a>
        </div>
        <div class="row">
            <div class="col-md-6">
